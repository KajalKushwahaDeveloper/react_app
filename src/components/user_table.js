              ...
              <td align="right">
                <div style={{display:'flex', alignItems:'center'}}>
                  <div style={{display:'flex', flexDirection:'column'}}>
                      <h3>{row.user?.username || 'N/A'}</h3>
                      <ul>
                        <li>{row.user?.emulatorSsid|| 'N/A'}</li>
                        <li>{row.id}</li>
                        <li>{row.status}</li>
                      </ul>
                  </div>
                  <IconButton  style={{height:'auto', width:'40px', margin:'40px'}}aria-label="edit">
                    <EditIcon />
                  </IconButton>
                    <button style={{height:'40px'}}>Enabled</button>
                </div>
              </td>
            </tr>
          ))}
