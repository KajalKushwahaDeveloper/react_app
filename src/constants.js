...
export const MESSAGE_URL = BASE_URL + '/message/allMessages'
export const MESSAGE_SEND_MSG = MESSAGE_URL + '/sendMessage'
...
export const REALNUMBER = EMULATOR_URL + '/getMessages'