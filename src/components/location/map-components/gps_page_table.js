...
const GpsTable = () => {
  ...
  const handleMessageIconClicked = (row) => {
    setContactDialogOptions({
      ...
      dialogType: 'message',
      emulatorId: row.id,
      realNumber: row.realTelephone,
      emulatorSsid: row.emulatorSsid,
                  ...
                  {(rowsPerPage > 0
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          <Tooltip
                            title={emulator.realTelephone || 'N/A'}
                            placement="top"
                          >
                            <div
                              style={{ display: 'flex', alignItems: 'center' }}
                            >
                              <div>{emulator.realTelephone || 'N/A'}</div>
                              {/* Icons */}
                              <div style={{ display: 'flex' }}>
                                ...
                                <IconButton
                                  size="small"
                                  disabled={!emulator?.realTelephone}
                                  onClick={(e) => {
                                    e.stopPropagation()
